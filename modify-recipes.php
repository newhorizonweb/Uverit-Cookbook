...
<html lang="pl-PL">
    ...
    <head>
        ...
        <!-- Site -->
        <!-- In-page -->
        <title>Uverit Cookbook - Modyfikuj Przepisy</title>
        <meta name="description" content="Popraw błędy, zmień składniki, zmodyfikuj lub usuń stworzony wcześniej przepis.">
        ...
        function nullList(){
            ...
            $(".empty-list").on("mouseout", function(){
                $(".empty-list h4").html("Brak Przepisów");
            });
        ...
        $('#search-form').on('input click', 'input.search-bar', function(e){
            // the onclick event has to be on the search-bar, otherwise it will reappear the search result list after clicking on the <li> (recipe)
            ...
            if (searchBar > 1) {
                $.ajax({
                    type: "post",
                    url: 'Php/search-bar-modify-recipes.php',
            ...
            // Show the recipe after clicking on the list
            ...
            if (sendForm){
                $.ajax({
                    ...
                    success: function(){
                        ...
                        $("#placeholder-text").html("Przepis zaktualizowany!");
