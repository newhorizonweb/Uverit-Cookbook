...
function mainTiles(){
    document.querySelector(".main-module-content").innerHTML = 
        "<div class='main-row'>" +
...
function baseNav(){
    document.querySelector(".navbar-inner").innerHTML = 
        "<div class='nav-top'>" +
            "<div class='close-nav'>" +
    ...
    // Compare the anchor href attribute to the page url name and add a class to the current page

    let pageName = window.location.pathname.slice(1, -4);
    let navLinks = document.querySelectorAll(".nav-link");

    navLinks.forEach((navLink) => {
        let navHref = navLink.getAttribute("href");
    ...
    // Close button
    let closeNavBtn = document.getElementsByClassName("close-nav")[0];
